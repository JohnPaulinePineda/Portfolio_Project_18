...
|             **[A.1.1]** **LDA_FULL (Linear Discriminant Analysis Without Univariate Filters)**: Cross-Validation ROC Curve AUC = 0.80151, Test ROC Curve AUC = 0.77199 
|             **[A.1.2]** **LDA_UF_NANC (Linear Discriminant Analysis With Univariate Filters Using No P-Value Adjustment and No Correlated Predictors)**: Cross-Validation ROC Curve AUC = 0.84130, Test ROC Curve AUC = 0.88657 
|      **[A.2]** **RF: Random Forest** (<mark style="background-color: #CCECFF">**randomForest**</mark> package)
|             **[A.2.1]** **RF_FULL (Random Forest Without Univariate Filters)**: Cross-Validation ROC Curve AUC = 0.78268, Test ROC Curve AUC = 0.79803 
|             **[A.2.2]** **RF_UF_NANC (Random Forest With Univariate Filters Using No P-Value Adjustment and No Correlated Predictors)**: Cross-Validation ROC Curve AUC = 0.81301, Test ROC Curve AUC = 0.82002  
|      **[A.3]** **NB: Naive Bayes** (<mark style="background-color: #CCECFF">**klaR**</mark> package)
|             **[A.3.1]** **NB_FULL (Linear Discriminant Analysis Without Univariate Filters)**: Cross-Validation ROC Curve AUC = 0.73904, Test ROC Curve AUC = 0.68055 
|             **[A.3.2]** **NB_UF_BAC (Naive Bayes With Univariate Filters Using Bonferroni-Adjusted P-Values and With Correlated Predictors)**: Cross-Validation ROC Curve AUC = 0.76825, Test ROC Curve AUC = 0.75231 
|             **[A.3.3]** **NB_UF_BANC (Naive Bayes With Univariate Filters Using Bonferroni-Adjusted P-Values and No Correlated Predictors)**: Cross-Validation ROC Curve AUC = 0.76025, Test ROC Curve AUC = 0.76273 
|
